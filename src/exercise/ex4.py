...
data = tf.placeholder(tf.float32, (None,198,300,300))

with tf.Session() as sess:


    patient = np.empty((0, 198, 300, 300), dtype=np.float32)
    temp = np.empty((1, 198, 300, 300), dtype=np.float32)
    ...
    aa = sess.run(a, feed_dict={data : patient})
